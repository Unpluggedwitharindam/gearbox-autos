...
const carSchema = z.object({
  ...
  registration_year: z.number().int().min(1980).max(2100).optional().nullable(),
  owner_count: z.number().int().min(1).max(10).optional().nullable(),
  seller_type: z.enum(["dealer", "private", "unknown"]).optional().nullable(),
  registration_state: z.string().max(100).optional().nullable(),
  accident_history: z.string().max(1000).optional().nullable(),
  service_history: z.string().max(1000).optional().nullable(),
  insurance_status: z.string().max(500).optional().nullable(),
  condition_notes: z.string().max(2000).optional().nullable(),
  acquisition_price_inr: z.number().int().min(0).optional().nullable(),
  acquisition_date: z.string().optional().nullable(),
  listed_at: z.string().optional().nullable(),
  inventory_status: z.enum(["in_stock", "reserved", "sold", "inactive"]).default("in_stock"),
  sold_at: z.string().optional().nullable(),
  sold_price_inr: z.number().int().min(0).optional().nullable(),
