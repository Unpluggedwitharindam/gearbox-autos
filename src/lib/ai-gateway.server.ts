...
export function createGarageAi(lovableApiKey: string, initialRunId?: string) {
...
export async function withGarageRunId(response: Response, gateway: ReturnType<typeof createGarageAi>) {
